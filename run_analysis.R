...
# Create more descriptive variable name

#features$feature_name <- features[, gsub("^t", "time", feature_name)]
#features$feature_name <- features[, gsub("^f", "frequency", feature_name)]
#features$feature_name <- features[, gsub("Acc", "Accelerometer", feature_name)]
#features$feature_name <- features[, gsub("Gyro", "Gyroscope", feature_name)]
#features$feature_name <- features[, gsub("Mag", "Magnitude", feature_name)]
#features$feature_name <- features[, gsub("BodyBody", "Body", feature_name)]
